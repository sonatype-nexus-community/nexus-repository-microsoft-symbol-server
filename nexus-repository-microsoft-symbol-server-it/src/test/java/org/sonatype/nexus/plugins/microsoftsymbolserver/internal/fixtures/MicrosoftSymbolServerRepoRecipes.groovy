...
/**
 * Factory for Microsoft Symbol Server {@link Repository} {@link Configuration}
 */
@CompileStatic
trait MicrosoftSymbolServerRepoRecipes
    extends ConfigurationRecipes
{
  @Nonnull
  Repository createMicrosoftSymbolServerProxy(final String name,
