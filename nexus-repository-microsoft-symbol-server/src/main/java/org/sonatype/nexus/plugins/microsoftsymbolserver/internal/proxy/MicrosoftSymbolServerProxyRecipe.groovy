 ...
 * @since 0.0.1
 */
@Named(MicrosoftSymbolServerProxyRecipe.NAME)
@Singleton
class MicrosoftSymbolServerProxyRecipe
    extends MicrosoftSymbolServerRecipeSupport
{
  public static final String NAME = 'microsoft-symbol-server-proxy'

  @Inject
  Provider<MicrosoftSymbolServerProxyFacetImpl> proxyFacet
  ...
  @Inject
  MicrosoftSymbolServerProxyRecipe(@Named(ProxyType.NAME) final Type type,
