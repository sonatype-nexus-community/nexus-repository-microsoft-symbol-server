 ...
 */
package org.sonatype.nexus.plugins.microsoftsymbolserver.internal.util;
...
@Named
@Singleton
public class MicrosoftSymbolServerPathUtils
{
  ...
  public String buildAssetPath(final State matcherState, final String assetName) {
    return String.format("/%s/%s%s", path(matcherState), assetName, PDB);
  }
}
